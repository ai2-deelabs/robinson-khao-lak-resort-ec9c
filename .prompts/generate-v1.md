...
split-screen hero with vehicle photo left, rigid ticket-stub text grid right — condensed geometric sans (like Eurostile) for headers, monospace for schedule/price data — Bangkok International Airport signage system: signal blue #0057B8 + porcelain white #F7F9FB + safety yellow #FFCC00 accent for CTAs — brisk, punctual, transactional efficiency
